...
public class XmlConfigurationUtilTest {
    ...
    public void getProperty() throws IOException {
        for (int i = 0; i < COUNT_OF_TEST_FIELDS; i++) {
            ...
            String actualValue = XmlConfigurationUtil.getConfigurationEntry(String.format(FIELD_NAME, i));
    ...
    public void getNotExistProperty() throws IOException {
        Assertions.assertNull(XmlConfigurationUtil.getConfigurationEntry(String.format(FIELD_NAME, NOT_EXIST_NUM_OF_FIELD)));
    }

    @Test
    public void getPropertyMap() throws IOException {
        Map<Integer, String> map = XmlConfigurationUtil.getConfigurationEntriesMap(LIST_NAME);
    ...
    public void getNotExistPropertyMap() throws IOException {
        Map<Integer, String> map = XmlConfigurationUtil.getConfigurationEntriesMap(LIST_NAME + NOT_EXIST_NUM_OF_FIELD);
        Assertions.assertEquals(0, map.size());
    }
    @Test
    public void getPropertyList() throws IOException {
        List<String> map = XmlConfigurationUtil.getConfigurationEntriesList(LIST_NAME);
        Assertions.assertEquals(LIST_LENGTH, map.size());
        for (int i = 0; i < LIST_LENGTH; i++) {
    ...
    public void getNotExistPropertyList() throws IOException {
        List<String> map = XmlConfigurationUtil.getConfigurationEntriesList(LIST_NAME + NOT_EXIST_NUM_OF_FIELD);
        Assertions.assertEquals(0, map.size());
    }
}
